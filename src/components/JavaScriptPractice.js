...
const JavaScriptPractice = () => {
    ...
    // Initialize 20 random questions
    const initializeQuestions = useCallback(() => {
        const shuffled = [...ques01_60, ...ques61_120, ...ques121_180].sort(() => 0.5 - Math.random());
        ...
        <div className="javascript-practice">
            ...
            <div className="question-container">
                ...
                <div className="question-content">
                    <div className="question-text">
                        <ReactMarkdown components={components}>{currentQuestion.question}</ReactMarkdown>
                    </div>
                </div>
                    ...
                    {showSolution && (
                        <div className="solution-content">
                            ...
                            <div className="solution-text">
                                <ReactMarkdown components={components}>{currentQuestion.solution}</ReactMarkdown>
                            </div>
                        </div>
                    )}
                </div>
            ...
            <div className="session-stats">
                ...
                <button onClick={handleNewSession} className="new-session-btn">
                    New Session (50 Random Questions)
                </button>
            </div>
        </div>
    );
